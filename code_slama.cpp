...
#define cin_arr(arr,x) ll arr[x];for(int i=0;i<x;i++)cin>>arr[i];
#define cin_arr2(arr,x,y) int arr[x][y];for(int i=0;i<x;i++){for(int j=0;j<y;j++)cin>>arr[i][j];}
/*_________print___________*/
#define pr1(x) cout<<x
#define pr2(x,y) cout<<x<<" "<<y
#define pri_arr(arr,x) int arr[x];for(int i=0;i<x;i++)cout<<arr[i]<<" ";
/*___*****yes & no*****___*/
#define YES cout<<"YES\n"
#define Yes cout<<"Yes\n"
#define yes cout<<"yes\n"
